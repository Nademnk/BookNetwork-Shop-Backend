...
import { PageResponsesFeedBackResponse } from '../models/page-responses-feed-back-response';
...
export class FeedbackService extends BaseService {
   ...
   */
  findAllFeedbackByBook$Response(params: FindAllFeedbackByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponsesFeedBackResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllFeedbackByBook(params: FindAllFeedbackByBook$Params, context?: HttpContext): Observable<PageResponsesFeedBackResponse> {
    return this.findAllFeedbackByBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponsesFeedBackResponse>): PageResponsesFeedBackResponse => r.body)
    );
  }
